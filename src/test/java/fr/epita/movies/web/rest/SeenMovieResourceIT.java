...
public class SeenMovieResourceIT {
    ...
    public void createSeenMovie() throws Exception {
        ...
        restSeenMovieMockMvc.perform(post("/api/seen-movies").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(seenMovie)))
    ...
    public void updateSeenMovie() throws Exception {
        ...
        restSeenMovieMockMvc.perform(put("/api/seen-movies").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(updatedSeenMovie)))
            .andExpect(status().isOk());
    ...
    public void deleteSeenMovie() throws Exception {
        ...
        restSeenMovieMockMvc.perform(delete("/api/seen-movies/{id}", seenMovie.getId()).with(csrf())
