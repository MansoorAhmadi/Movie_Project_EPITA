...
import fr.epita.movies.config.Constants;
import fr.epita.movies.domain.Authority;
import fr.epita.movies.domain.PersistentToken;
import fr.epita.movies.domain.User;
import fr.epita.movies.repository.AuthorityRepository;
import fr.epita.movies.repository.PersistentTokenRepository;
import fr.epita.movies.repository.UserRepository;
import fr.epita.movies.security.AuthoritiesConstants;
import fr.epita.movies.service.UserService;
import fr.epita.movies.service.dto.PasswordChangeDTO;
import fr.epita.movies.service.dto.UserDTO;
import fr.epita.movies.web.rest.vm.KeyAndPasswordVM;
import fr.epita.movies.web.rest.vm.ManagedUserVM;
...
import static fr.epita.movies.web.rest.AccountResourceIT.TEST_USER_LOGIN;
