...
import fr.epita.movies.config.audit.AuditEventConverter;
import fr.epita.movies.domain.PersistentAuditEvent;
import fr.epita.movies.repository.PersistenceAuditEventRepository;
import fr.epita.movies.security.AuthoritiesConstants;

import fr.epita.movies.service.AuditEventService;
