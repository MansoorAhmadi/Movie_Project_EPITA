  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="moviesApp.contact.home.createOrEditLabel">Create or edit a Contact</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : contactEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="contact-movieUser" type="select" className="form-control" name="movieUser.id">
                  <option value="" key="0" />
                  {movieUsers
