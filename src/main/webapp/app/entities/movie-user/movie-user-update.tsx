...
export const MovieUserUpdate = (props: IMovieUserUpdateProps) => {
  ...
  const { movieUserEntity, roles, contacts, loading, updating } = props;

  const handleClose = () => {
    props.history.push('/movie-user');
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="moviesApp.movieUser.home.createOrEditLabel">Create or edit a MovieUser</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
