  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="moviesApp.address.home.createOrEditLabel">Create or edit a Address</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : addressEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="address-contact" type="select" className="form-control" name="contact.id">
                  <option value="" key="0" />
                  {contacts
