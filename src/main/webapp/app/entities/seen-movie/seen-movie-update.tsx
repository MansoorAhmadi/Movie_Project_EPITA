  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="moviesApp.seenMovie.home.createOrEditLabel">Create or edit a SeenMovie</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : seenMovieEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="seen-movie-movie" type="select" className="form-control" name="movie.id">
                  <option value="" key="0" />
                  {movies
              ...
              <AvGroup>
                ...
                <AvInput id="seen-movie-movieUser" type="select" className="form-control" name="movieUser.id">
                  <option value="" key="0" />
                  {movieUsers
